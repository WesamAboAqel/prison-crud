...
const EditManager = ({params, updateManager}) => {
    ...
    const [staffCount,setStaffCount] = useState(manager.staff_count)
    const [facilityId, setFacilityId] = useState(manager.facility_id)
  ...
  return (
    ...
    {loading ? (<Spinner loading={loading} />): (<section className="bg-gray-200">
      <div className="container m-auto max-w-2xl py-24">
        <div
          className="bg-custom1-25 px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0"
        >
          <form onSubmit={submitForm}>
            <h2 className="text-3xl text-center font-semibold mb-6">Edit Manager</h2>
